    ...
    plugins.withId("com.android.application") {
        dependencies {
            constraints {
                ...
                add("implementation", "io.netty:netty-handler:4.2.14.Final")
                add("implementation", "io.netty:netty-codec-http2:4.2.14.Final")
                add("implementation", "io.netty:netty-codec-http:4.2.14.Final")
                add("implementation", "io.netty:netty-codec:4.2.14.Final")
                add("implementation", "io.netty:netty-common:4.2.14.Final")
